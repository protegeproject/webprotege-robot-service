 ...
 *
 * @param header
 *          pipe-separated list of column definitions (required). Special keywords include: IRI, ID,
 *          LABEL, SYNONYMS, SubClass Of, SubClasses, Equivalent Class, SubProperty Of, Equivalent
 *          Property, Disjoint With, Type, Domain, Range. May also reference properties by CURIE or
 *          label.
 * @param format
