...
import static edu.stanford.protege.robot.pipeline.event.LoadOntologySucceededEvent.CHANNEL;
...
public record LoadOntologySucceededEvent(
  ...
  public static final String CHANNEL = "webprotege.events.robot.LoadOntologySucceeded";
